...
- **Jeiner Andy Josué Pineda Corleto**: Desarrollo de la aplicación e investigación sobre el prompt a utilizar.
- **Tahly Yuliana Jiménez Boteo**: Investigación sobre API a utilizar y documentación del proyecto.
